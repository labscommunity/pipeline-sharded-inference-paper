...
\begin{table}[ht]
\centering
\caption{Gemma~4~E2B distributed pipeline (FP32, 2-stage). Micro-batching takes the 2-node distributed configuration from $61\%$ to $102\%$ of the 1-stage single-node baseline.}
